...
if(rabbit.facade.getUserPref("hidePageFrameSimulation")){
this.hideFrameButton.hide();
...
_3fe=rabbit.parameters.fitScreen;
}
}
var _3ff=false;
if(rabbit.parameters.isApi){
...
_3ff=!rabbit.parameters.showFrame;
}
}
...
var _408=!rabbit.facade.getUserPref("hidePageFrameSimulation");
...
var _414=!rabbit.facade.getUserPref("hidePageFrameSimulation");
if(_414){
...
this.simulationScaled.css({transform:"scale(1)"});
var _415=1;
if(rabbit.facade.getUserPref("simulationFitScreen")&&!_40b&&_414){
var _416=30;
...
if(!rabbit.facade.getUserPref("hidePageFrameSimulation")&&this.borderWrapper[0].scrollWidth>_419){
_41a+=rabbit.util.getScrollbarWidth();
}
if(!rabbit.facade.getUserPref("hidePageFrameSimulation")&&this.borderWrapper[0].scrollHeight>_41a){
